...
const BlogCard: React.FC<BlogCardProps> = ({
  imageUrl = "https://cdn.builder.io/api/v1/image/assets/TEMP/ee5bdbc32bbc53684deecb2f9d63712884517174ee790d5d45a4eae8116d726d?apiKey=971b6410d97242e7b97afd5891e4e40f&",
  category,
  readTime,
  title,
  description,
  ...
  return (
    <article className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
      <div
        className={`flex flex-col grow text-base leading-6 text-black max-md:mt-8 ${
